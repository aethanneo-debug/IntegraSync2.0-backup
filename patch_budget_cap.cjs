...
const target = `                          <div className="mt-4 pt-3 border-t border-slate-100 flex justify-end">
                            <button
                              onClick={() => {
...
const replacement = `                          <div className="mt-4 pt-3 border-t border-slate-100 flex justify-end">
...
// Use replaceall / regex global to replace all occurrences
